...
class LegacyGanttTheme {
  ...
  LegacyGanttTheme({
    ...
    this.gridColor = const Color(0x33888888), // Colors.grey.withValues(alpha:51)
    ...
    this.timeRangeHighlightColor = const Color(0x0D000000), // Colors.black.withValues(alpha:13)
    this.containedDependencyBackgroundColor = const Color(0x1A000000), // Colors.black.withValues(alpha:26)
    this.emptySpaceHighlightColor = const Color(0x0F2196F3), // Colors.blue.withValues(alpha:15)
